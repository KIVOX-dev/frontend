        ...
        <div className="screen active" id="screen-hr-dash">
          <div className="hero">
            ...
            <div className="hero-sub">
              Browse AI-scored aptitude profiles, view job-role badges, and shortlist directly from the TalentSnaps leaderboard.
            </div>
          ...
          <div className="g2">
            ...
            <div className="card" style={{ background: "var(--surface2)" }}>
              ...
              <div style={{ background: "var(--green-l)", border: "1.5px solid rgba(14,159,110,.18)", borderRadius: "var(--r2)", padding: "12px", fontSize: "12px", color: "var(--text)", lineHeight: 1.6 }}>
                <strong style={{ color: "var(--green)" }}>Who sees this?</strong> All TalentSnaps students matching your filters will see this vacancy in their Profile Summarizer → Open Roles tab.
              </div>
            </div>
          </div>
        </div>
