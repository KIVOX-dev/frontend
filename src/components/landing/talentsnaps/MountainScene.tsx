...
export function LandscapeArt({ className = "ts-art" }: { className?: string } = {}) {
  return (
    <svg className={className} viewBox="0 0 1440 840" preserveAspectRatio="xMidYMax slice" role="img" aria-label="A green mountain valley: layered snow capped peaks, forested slopes, meadows and a pale winding path">
        ...
        <path d="M280 840 C 318 800 370 776 406 748 C 442 720 440 692 480 670 C 514 646 548 618 572 588 C 588 566 593 540 597 514 C 599 504 598 497 599 491 C 601 499 601 510 603 522 C 607 548 605 576 601 602 C 597 628 572 650 546 670 C 526 684 510 686 510 688 C 474 710 472 734 438 758 C 404 782 344 806 312 840 Z" fill="#ECF4DC"/>
