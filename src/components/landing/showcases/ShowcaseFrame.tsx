...
import { MagnifyingGlass, Bell, Funnel } from "@phosphor-icons/react";
...
export function ShowcaseFrame({
  ...
  return (
    ...
    <div className="w-[640px] max-w-[640px] shrink-0 rounded-[1.75rem] bg-ink/[0.04] ring-1 ring-ink/5 p-1.5">
      <Card className="p-0 overflow-hidden rounded-[calc(1.75rem-0.375rem)] shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]">
        {/* Browser chrome */}
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex items-center gap-2.5 px-4 py-2.5 border-b border-line shrink-0">
              <div className="flex-1 h-8 rounded-md bg-[var(--color-sidebar)] flex items-center px-2.5 gap-1.5 min-w-0 max-w-xs">
                <MagnifyingGlass className="size-3.5 text-ink-faint shrink-0" />
